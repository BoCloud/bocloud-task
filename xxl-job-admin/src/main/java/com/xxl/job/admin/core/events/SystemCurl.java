...
//        service_name = "paas-basic-task";
		if (consul_host != null) {
			...
			// acl_token = acl_token == null ? "787bd467-a93e-8558-1aaf-f7c4036c406b" :
			// acl_token;
...
//                    "}";
			String b = "{" + "\"ID\":\"" + service_id + "\"," + "\"Name\":\"" + service_name + "\"," +
//					    "\"Datacente\":\"boclouddatacentor\","+
					"\"Tags\":[" + "    \"urlprefix-/bocloud-task\"," + "    \"secure=false\"" + "]," + "\"Address\":\""
					+ hostAddress + "\"," + "\"Port\":" + service_port + "," + "\"EnableTagOverride\":true,"
					+ "\"Check\":{" + "    \"name\":\"tcp Health test\","
					+ "    \"DeregisterCriticalServiceAfter\":\"90m\"," + "    \"Interval\":\"10s\","
					+ "    \"timeout\":\"1s\"," + "    \"tcp\":\"" + hostAddress + ":" + service_port + "\"" + "}"
					+ "}";
